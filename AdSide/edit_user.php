		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					...
					{
						$user_id = $_GET['id'];
						$users = "SELECT * FROM users1 WHERE id='$user_id'";
					...
					<form action="edit_userDB.php" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input type="text" name="batch" value="<?=$user['batch'];?>" lass="form-control">
							</div>
							<div class="col-md-6 mb-3">
							...
							<div class="col-md-6 mb-3">
								...
								<select name="role_as" required class="form-control">
									...
									<option value="0"<?= $user['role_as'] == '0' ? 'selected':''?>>Alumni</option>
								</select>
							</div>
							<div class="col-md-6 mb-3">
